    ...
    <Layout>
      <PageHeader 
        ...
        action={
          <div className="flex gap-2">
            <Link href="/close/new">
              <Button size="sm" className="flex"><Plus className="w-4 h-4 mr-2" /> Nuova Chiusura</Button>
            </Link>
      ...
      <div className="flex flex-col md:flex-row gap-4 mb-6 items-center justify-between">
        ...
        <div className="flex flex-row gap-3 w-full md:w-auto">
          ...
          {activeTab==="analytics" && (
            <Card className="p-2 pl-4 pr-0 flex items-center gap-2 w-1/2 md:min-w-[180px]">
              <select 
